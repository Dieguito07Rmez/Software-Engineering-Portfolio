        ...
        <table border=1>
            ...
            <tr>
                ...
                <td>
                    ...
                    @endif
                    <input type="text" class="form-control" name="dirigido" id="dirigido" value="{{old('dirigido')}}">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    @endif
                    <input type="text" class="form-control" name="encargado1" id="encargado1" value="{{old('encargado1')}}">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    @endif
                    <input type="text" class="form-control" name="encargado2" id="encargado2" value="{{old('encargado2')}}">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    @endif
                    <input type="text" class="form-control" name="descripcion" id="{{old('descripcion')}}">
                </td>
            </tr>
            <tr>
